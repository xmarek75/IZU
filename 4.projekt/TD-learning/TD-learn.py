...
Alpha = 0.1
Gamma = 0.9
Path = '1 2 3 8 13 18 19 20 15 14 9'
Utilities = \
    """
 -0.000 -0.005 -0.025 -0.100 -0.000
  rew=1  0.271 -0.054 rew=-1 -0.103
  0.271  0.032 -0.025 -0.040 -0.022
...
if __name__ == '__main__':
    ...
    utilities = [(format(i['raw'], '>7') if i['isReward'] 
        else '{:7.5f}'.format(round(i['utility'], 5)))
        for i in utilities]
